...
const DEFAULT_INVENTORY_SETTINGS = {
  ...
  lowInventoryPct: 100,
  emailOnNewShortage: false,
  emailOnQuantityChange: false,
  emailOnPriorityChange: false,
  emailOnNewShortageFromSync: false,
  emailOnCriticalOrUrgent: false,
  emailOnResolvedShortage: false,
